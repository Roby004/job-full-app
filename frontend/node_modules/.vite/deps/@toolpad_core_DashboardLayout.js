import {
  ...
  MenuOpen_default,
  MoreVert_default
} from "./chunk-YT4XCPK5.js";
import {
  Menu_default
} from "./chunk-RHK2YIV4.js";
import {
  BrandingContext,
  Link,
  NavigationContext,
...
} from "./chunk-JZ7J5EBN.js";
import "./chunk-75ECT5ZD.js";
import {
  Stack_default
} from "./chunk-P5B53SMY.js";
import {
  Avatar_default
} from "./chunk-JGX254VD.js";
import {
  Typography_default
} from "./chunk-63WSP7HR.js";
import "./chunk-AUABC3IS.js";
import "./chunk-ZCSSBJ3Q.js";
import {
  Box_default
} from "./chunk-WFQZNENO.js";
import {
  InitColorSchemeScript_default,
  ThemeProvider,
  useColorScheme
} from "./chunk-VPH7GBSS.js";
import {
  Grow_default,
  Tooltip_default
} from "./chunk-CEVDCPA5.js";
import "./chunk-N5SEV7LI.js";
import "./chunk-TAKCCPUR.js";
import "./chunk-C6WWHQR7.js";
import "./chunk-CZFKCJCL.js";
import "./chunk-TZACKB55.js";
import "./chunk-TCQGHAJ3.js";
import "./chunk-72T66GRT.js";
import "./chunk-3F2LFMMG.js";
import "./chunk-NB5FO3JZ.js";
import "./chunk-SNPHBITZ.js";
import "./chunk-H7IAH3KP.js";
import {
  useTheme
} from "./chunk-NOCJXQAH.js";
import {
  createTheme,
  require_prop_types,
  styled_default,
...
function Account(props) {
  ...
  if (!(session == null ? void 0 : session.user)) {
    ...
    accountContent = (0, import_jsx_runtime13.jsxs)(React18.Fragment, {
...
function useActivePage() {
  const navigationContext = React19.useContext(NavigationContext);
  const routerContext = React19.useContext(RouterContext);
...
function DashboardSidebarSubNavigation({
  ...
  const navigationContext = React20.useContext(NavigationContext);
  const activePage = useActivePage();
  const initialExpandedSidebarItemIds = React20.useMemo(() => subNavigation.map((navigationItem, navigationItemIndex) => ({
    navigationItem,
  ...
  const [expandedSidebarItemIds, setExpandedSidebarItemIds] = React20.useState(initialExpandedSidebarItemIds);
  const [hoveredMiniSidebarItemId, setHoveredMiniSidebarItemId] = React20.useState(null);
  const handleOpenFolderClick = React20.useCallback((itemId) => () => {
    ...
    children: subNavigation.map((navigationItem, navigationItemIndex) => {
      ...
      if (navigationItem.kind === "divider") {
        ...
        return (0, import_jsx_runtime14.jsx)("li", {
          children: (0, import_jsx_runtime14.jsx)(Divider_default, {
            sx: {
              borderBottomWidth: 2,
              mx: 1,
              mt: 1,
      ...
      const listItem = (0, import_jsx_runtime14.jsxs)(ListItem_default, {
        ...
        children: [(0, import_jsx_runtime14.jsxs)(NavigationListItemButton, {
          ...
          children: [navigationItem.icon || isMini ? (0, import_jsx_runtime14.jsxs)(Box_default, {
            sx: {
              position: "relative",
              top: isMini ? -6 : 0,
              left: isMini ? 5 : 0
            },
            children: [(0, import_jsx_runtime14.jsxs)(ListItemIcon_default, {
              sx: {
                display: "flex",
                alignItems: "center",
            ...
            }), isMini ? (0, import_jsx_runtime14.jsx)(Typography_default, {
              variant: "caption",
              sx: {
                position: "absolute",
                bottom: -18,
          ...
          }) : null, !isMini ? (0, import_jsx_runtime14.jsx)(ListItemText_default, {
          ...
          }) : null, navigationItem.action && !isMini && isFullyExpanded ? navigationItem.action : null, navigationItem.children ? (0, import_jsx_runtime14.jsx)(ExpandMore_default, {
            sx: nestedNavigationCollapseSx
          }) : null]
        }), navigationItem.children && isMini ? (0, import_jsx_runtime14.jsx)(Grow_default, {
          in: navigationItemId === hoveredMiniSidebarItemId,
          children: (0, import_jsx_runtime14.jsx)(Box_default, {
            sx: {
              position: "fixed",
      ...
      return (0, import_jsx_runtime14.jsxs)(React20.Fragment, {
        children: [listItem, navigationItem.children && !isMini ? (0, import_jsx_runtime14.jsx)(Collapse_default, {
...
function useSsr() {
  return React21.useSyncExternalStore(subscribe2, getSnapshot2, getServerSnapshot);
}
...
function ThemeSwitcher() {
  ...
  const {
    ...
    setPaletteMode,
    isDualTheme
  } = React22.useContext(PaletteModeContext);
  const toggleMode = React22.useCallback(() => {
  ...
  return isDualTheme ? (0, import_jsx_runtime15.jsx)(Tooltip_default, {
    ...
    children: (0, import_jsx_runtime15.jsx)("div", {
      children: (0, import_jsx_runtime15.jsx)(IconButton_default, {
        ...
        children: theme.getColorSchemeSelector ? (0, import_jsx_runtime15.jsxs)(React22.Fragment, {
        ...
        }) : (0, import_jsx_runtime15.jsx)(React22.Fragment, {
...
function useApplicationTitle() {
  const branding = React25.useContext(BrandingContext);
...
function AppTitle(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(Link, {
    ...
    children: (0, import_jsx_runtime18.jsxs)(Stack_default, {
      ...
      children: [(0, import_jsx_runtime18.jsx)(LogoContainer, {
        children: ((_c = props == null ? void 0 : props.branding) == null ? void 0 : _c.logo) ?? (_ToolpadLogo || (_ToolpadLogo = (0, import_jsx_runtime18.jsx)(ToolpadLogo, {
          size: 40
        })))
...
function DashboardLayout(props) {
  ...
  const theme = useTheme();
  const brandingContext = React27.useContext(BrandingContext);
  const navigationContext = React27.useContext(NavigationContext);
  const appWindowContext = React27.useContext(WindowContext);
  const branding = {
    ...brandingContext,
    ...brandingProp
  };
  const navigation = navigationProp ?? navigationContext;
  const [isDesktopNavigationExpanded, setIsDesktopNavigationExpanded] = React27.useState(!defaultSidebarCollapsed);
  const [isMobileNavigationExpanded, setIsMobileNavigationExpanded] = React27.useState(false);
  ...
  const setIsNavigationExpanded = React27.useCallback((newExpanded) => {
    if (isOverMdViewport) {
  ...
  const [isNavigationFullyExpanded, setIsNavigationFullyExpanded] = React27.useState(isNavigationExpanded);
  const [isNavigationFullyCollapsed, setIsNavigationFullyCollapsed] = React27.useState(!isNavigationExpanded);
  React27.useEffect(() => {
  ...
  const handleSetNavigationExpanded = React27.useCallback((newExpanded) => () => {
    setIsNavigationExpanded(newExpanded);
  }, [setIsNavigationExpanded]);
  const toggleNavigationExpanded = React27.useCallback(() => {
    setIsNavigationExpanded(!isNavigationExpanded);
  }, [isNavigationExpanded, setIsNavigationExpanded]);
  const handleNavigationLinkClick = React27.useCallback(() => {
    setIsMobileNavigationExpanded(false);
  }, [setIsMobileNavigationExpanded]);
  const isDesktopMini = !disableCollapsibleSidebar && !isDesktopNavigationExpanded;
  const isMobileMini = !disableCollapsibleSidebar && !isMobileNavigationExpanded;
  const getMenuIcon = React27.useCallback((isExpanded) => {
  ...
  const getDrawerContent = React27.useCallback((isMini, viewport) => {
    var _a;
  ...
  }, [SidebarFooterSlot, handleNavigationLinkClick, hasDrawerTransitions, isNavigationFullyCollapsed, isNavigationFullyExpanded, navigation, slotProps == null ? void 0 : slotProps.sidebarFooter]);
  const getDrawerSharedSx = React27.useCallback((isMini, isTemporary) => {
  ...
  return (0, import_jsx_runtime19.jsxs)(Box_default, {
    ...
    children: [(0, import_jsx_runtime19.jsx)(AppBar, {
      ...
      children: (0, import_jsx_runtime19.jsx)(Toolbar_default, {
        sx: {
        ...
        children: (0, import_jsx_runtime19.jsxs)(Stack_default, {
          ...
          children: [(0, import_jsx_runtime19.jsxs)(Stack_default, {
            direction: "row",
            children: [!hideNavigation ? (0, import_jsx_runtime19.jsxs)(React27.Fragment, {
            ...
            }) : null, (slots == null ? void 0 : slots.appTitle) ? (0, import_jsx_runtime19.jsx)(slots.appTitle, {
               ...
               */
              (0, import_jsx_runtime19.jsx)(AppTitle, {
                branding,
                ...slotProps == null ? void 0 : slotProps.appTitle
              })
            )]
            ...
            }), (0, import_jsx_runtime19.jsx)(ToolbarAccountSlot, {
              ...slotProps == null ? void 0 : slotProps.toolbarAccount
            })]
          })]
        })
      })
    }), !hideNavigation ? (0, import_jsx_runtime19.jsxs)(React27.Fragment, {
