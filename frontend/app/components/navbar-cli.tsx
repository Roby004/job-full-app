...
function ToolbarActionsSearch() {
 ...
 <Avatar src="/app/images/avatar1.png" sx={{ cursor: 'pointer' }} onClick={handleAvatarClick} />
            ...
            <Menu anchorEl={anchorEl} open={open} onClose={handleClose}>
              <MenuItem >
               <Link to={'/employe/profil'} style={{ textDecoration: 'none', color: '#333' }}>
               Profil
              </Link> </MenuItem>
...
export default function NavbarCli () {
  return (
    <div className="flex pt-0 rounded-3xl border border-gray-200 w-full " style={{ justifyContent: 'space-between', padding: '10px', backgroundColor: 'white' }}>
      <CustomAppTitle />
